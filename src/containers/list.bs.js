...
var Monoid$CreedOopPatterns = require("../hkts/monoid.bs.js");
var Functor$CreedOopPatterns = require("../hkts/functor.bs.js");
var Foldable$CreedOopPatterns = require("../hkts/foldable.bs.js");
...
var L = Higher$CreedOopPatterns.Newtype1({ });
...
function monoid_list(param) {
  if (!class_tables[0]) {
    ...
    var mempty = ids[0];
    var mappend = ids[1];
    var inh = CamlinternalOO.inherits($$class, 0, shared, 0, Monoid$CreedOopPatterns.monoid_, false);
    var obj_init = inh[0];
  ...
  return Curry._1(class_tables[0], [
              undefined,
              Monoid$CreedOopPatterns.monoid_[3]
            ]);
}
...
function foldable_list(param) {
  if (!class_tables$1[0]) {
    ...
    var inh = CamlinternalOO.inherits($$class, 0, ["foldr"], [
          ...
          "null",
          "toList"
        ], Foldable$CreedOopPatterns.foldable_, false);
    var obj_init = inh[0];
  ...
  return Curry._1(class_tables$1[0], [
              undefined,
              Foldable$CreedOopPatterns.foldable_[3]
            ]);
}
